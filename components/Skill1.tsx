...
const Skill1 = (directionLeft: Props) => {
  return (
    <div className='group relative flex cursor-pointer top-10 right-10'>
        ...
        src='cpp.png' className='rounded-full border-gray-500 object-cover sm:w-10 sm:h-10 md:w-20 md:h-20 xl:w-20 xl:h-20 filter group-hover:grayscale transition duration-300 ease-in-out'
        />
